 ...
 * records/s/core at peak times a declared 1 s horizon. Two cores divide
 * it, so each gets 2^18 records — 1.97 s of that peak. EL2-mapped
 * already, never in a guest's Stage 2. */
