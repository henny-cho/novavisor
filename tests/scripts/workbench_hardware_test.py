...
from novakit.services.workbench import hardware  # noqa: E402
...
class BoardMapTest(unittest.TestCase):
    ...
    def test_slot_arithmetic_matches_the_abi(self):
        # The UI turns a scheduler slot into (vm, index) with this stride.
        self.assertEqual(self.map["vcpu_stride"], abi.MAX_VCPUS_PER_VM)
        self.assertEqual(self.map["max_guests"], abi.MAX_GUESTS)
